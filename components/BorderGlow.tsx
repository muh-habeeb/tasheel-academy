...
const BorderGlow: React.FC<BorderGlowProps> = ({
  ...
  useEffect(() => {
    ...
    const angleEnd = 465;
    // Defer initial state updates to avoid synchronous setState-in-effect warning
    setTimeout(() => {
      setSweepActive(true);
  ...
  return (
    <div
      ...
      className={`active:scale-[0.97] relative grid isolate border border-white/15 ${className}`}
      style={{
